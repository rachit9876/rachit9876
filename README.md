...
<div align="left">
  ...
  <img title="CSS3" alt="CSS3" width="45px" src="https://i.ibb.co/cK1KLdwb/css3-original.webp">
  <img title="SQL" alt="SQL" width="45px" src="https://i.ibb.co/v4mVrzMH/mysql-original.webp">
  
  <!-- Scripting -->
  <img title="Bash" alt="Bash" width="45px" src="https://i.ibb.co/JwzgLrm7/Bash-Logo-White.webp">
  <img title="PowerShell" alt="PowerShell" width="45px" src="https://i.ibb.co/HLzn9YXB/ps-black-64.webp">
  
  <!-- Operating Systems -->
  <img title="Linux" alt="Linux" width="45px" src="https://i.ibb.co/zVTgrPF3/linux-original.webp">
  <img title="Ubuntu" alt="Ubuntu" width="45px" src="https://i.ibb.co/6cH4vdpx/ubuntu-tile.webp">
  <img title="Kali Linux" alt="Kali Linux" width="45px" src="https://i.ibb.co/jZ9FYBvq/kali-dragon-icon.webp">
  <img title="Windows" alt="Windows" width="45px" src="https://i.ibb.co/8LZxgYmx/windows8-original.webp">
  
  <!-- Development Tools -->
  <img title="VS Code" alt="VS Code" width="45px" src="https://i.ibb.co/wF7pr53D/vscode-original.webp">
  <img title="Unity" alt="Unity" width="45px" src="https://i.ibb.co/CTrLcx3/Adobe-Express-file.webp">
  <img title="Colab" alt="Colab" width="45px" src="https://i.ibb.co/VcS6F895/file-20.webp">
  
  <!-- Version Control -->
  <img title="Git" alt="Git" width="45px" src="https://i.ibb.co/Dgtss887/git-original.webp">
  <img title="GitHub Desktop" alt="GitHub Desktop" width="45px" src="https://i.ibb.co/WN4Shnsv/Github-desktop-logo-symbol.webp">
  ...
  <img title="infinityfree" alt="Infinityfree" width="45px" src="https://i.ibb.co/XrN0X3ph/infinityfree.webp">

  <!-- Search/OSINT Tools -->
  <img title="Tineye" alt="Tineye" width="45px" src="https://i.ibb.co/5gfwrFDj/robot-DQDz-U-Wo.webp">
  ...
  <img title="MIT" alt="Express" width="45px" src="https://i.ibb.co/0VyRFTC8/MIT.webp">
  <img title="CopyLeft" alt="CopyLeft" width="45px" src="https://i.ibb.co/kgRbZV6W/copyLeft.webp">
  <img title="Nmap" alt="Nmap" width="45px" src="https://i.ibb.co/C3QPPbkz/Untitled.png">
  <img title="TOR" alt="Tor" width="45px" src="https://i.ibb.co/hJJBzYYh/Untitled-1.png">
  <img title="Burp Suit" alt="Burp suit" width="45px" src="https://i.ibb.co/QF70fTCP/Untitled-1.png">
</div>
